...
public class ChongzhiPasswordActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_zhucexieyi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(ChongzhiPasswordActivity.this);
                LayoutInflater inflater = LayoutInflater.from(ChongzhiPasswordActivity.this);
    ...
    private void fanhui(){
        lfanhui.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              Intent intent = new Intent(ChongzhiPasswordActivity.this,LoginActivity.class);
...
//                                        Log.e("验证",s);
                                            ...
                                            if (tongyongBean.getState()==1){
                                                Intent intent = new Intent(ChongzhiPasswordActivity.this,ResetPasswordActivity.class);
