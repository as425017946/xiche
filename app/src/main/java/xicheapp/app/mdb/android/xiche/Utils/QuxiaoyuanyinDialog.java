...
public class QuxiaoyuanyinDialog {
    //点击确认按钮回调接口
    ...
    public static void show(Activity activity, String content, final OnConfirmListener confirmListener){
        // 加载布局文件
        View view = View.inflate(activity, R.layout.quxiao_view, null);
        TextView confirm = (TextView) view.findViewById(R.id.confirm);
        TextView cancel = (TextView) view.findViewById(R.id.cancel);
        RadioGroup radioGroup = (RadioGroup) view.findViewById(R.id.quxiao_radiogroup);
